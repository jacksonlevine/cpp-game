...
namespace world
{
	std::unordered_map<std::string, objs::ColorBrick> World::generateWorld(perlin p, int ws, std::unordered_map<std::string, objs::FixedObject>& fomap)
	{
	...
	void World::insertIntoWorld(int x, int y, float red, float green, float blue, float a, float elevation, std::unordered_map<std::string, objs::ColorBrick>* wmap, objs::ColorBrick brick)
	{
		brick.col.r = red;
		brick.col.g = green;
		brick.col.b = blue;
	...
	std::unordered_map<char, sf::Color> World::getObjectPixReferences()
	{
